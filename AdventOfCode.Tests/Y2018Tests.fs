...
module ``Y2018 Tests`` =
    ...
    //[<Fact>]
    //let ``Day 01 Part 1`` () = Day01.Part1() |> should equal Unknown

    //[<Fact>]
    //let ``Day 01 Part 2`` () = Day01.Part2() |> should equal Unknown

    //[<Fact>]
    //let ``Day 02 Part 1`` () = Day02.Part1() |> should equal Unknown

    //[<Fact>]
    //let ``Day 02 Part 2`` () = Day02.Part2() |> should equal Unknown

    //[<Fact>]
    //let ``Day 03 Part 1`` () = Day03.Part1() |> should equal Unknown
        
    //[<Fact>]
    //let ``Day 03 Part 2`` () = Day03.Part2() |> should equal Unknown
    
    //[<Fact>]
    //let ``Day 04 Part 1`` () = Day04.Part1() |> should equal Unknown
        
    //[<Fact>]
    //let ``Day 04 Part 2`` () = Day04.Part2() |> should equal Unknown
    
    //[<Fact>]
    //let ``Day 05 Part 1`` () = Day05.Part1() |> should equal Unknown
        
    //[<Fact>]
    //let ``Day 05 Part 2`` () = Day05.Part2() |> should equal Unknown
    
    //[<Fact>]
    //let ``Day 06 Part 1`` () = Day06.Part1() |> should equal Unknown
        
    //[<Fact>]
    //let ``Day 06 Part 2`` () = Day06.Part2() |> should equal Unknown
    
    //[<Fact>]
    //let ``Day 07 Part 1`` () = Day07.Part1() |> should equal Unknown
            
    //[<Fact>]
    //let ``Day 07 Part 2`` () = Day07.Part2() |> should equal Unknown
    
    //[<Fact>]
    //let ``Day 08 Part 1`` () = Day08.Part1() |> should equal Unknown
                
    //[<Fact>]
    //let ``Day 08 Part 2`` () = Day08.Part2() |> should equal Unknown
    
    //[<Fact>]
    //let ``Day 09 Part 1`` () = Day09.Part1() |> should equal Unknown
                
    //[<Fact>]
    //let ``Day 09 Part 2`` () = Day09.Part2() |> should equal Unknown
    ...
    //[<Fact>]
    //let ``Day 25 Part 1`` () = Day25.Part1() |> should equal Unknown
                
    //[<Fact>]
    //let ``Day 25 Part 2`` () = Day25.Part2() |> should equal Unknown